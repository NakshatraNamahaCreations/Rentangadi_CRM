...
//         (a, b) => orderMap.indexOf(a.productId) - orderMap.indexOf(b.productId)
//       );
//     }
...
//         `${ApiURL}/Enquiry/update-product-data/${enquiry._id}`,
...
//         `${ApiURL}/Enquiry/delet-product-data/${enquiry._id}`,
//         { data: { productId } }
//       );
//       if (response.status === 200) {
...
//   const clientNo = enquiry?.clientDetails?.executives?.map(exec => exec.phoneNumber);
...
//       clientNo:
//         enquiry.clientDetails?.executives?.[0]?.phoneNumber || "",
...
//                 <span className="ms-2">{moment(enquiry?.createdAt).format('DD-MM-YYYY')}</span>
//               </div>
//               <div className="mb-2 d-flex align-items-center">
//                 <FaCalendarAlt className="me-2" />{" "}
...
//                 const stock =
//                   allProducts.find((ap) => ap.productId === p.productId)?.availableStock || p.stock;
...
//                     const stock =
//                       enquiry?.products?.find((ap) => ap.productId === p.productId)
//                         ?.qty || 0;
//                     // const orderQty =
//                     //   enquiry?.products?.find((ap) => ap._id === p.productId)
//                     //     ?.qty || 0;                   
//                     const orderQty =
//                       enquiry?.products?.find((ap) => ap.productId === p.productId)?.qty || 0;

//                     console.log(`orderQty: `, orderQty);
//                     console.log(`stock: `, stock);
//                     const canConfirm = stock <= p.availableStock;
...
//                               <span style={{ color: "#28a745", fontWeight: 600 }}>Confirmed</span>
//                             ) : (
...
//                             )
//                           ) : (
//                             <span style={{ color: "#6c757d", fontStyle: "italic" }}>Sent</span>
//                           )}
//                         </td>
...
//                   <Form.Control
//                     type="number"
//                     value={enquiry?.status === 'sent' ? enquiry.quotationData.adjustments : roundOff}
